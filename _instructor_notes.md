...
* Teaching "extras":
  * You can introduce coding shortcuts (i.e. Emmet) but make sure they have a grasp of what the code itself means. Strong foundation *first*.
...
Go at the pace of the learners.  If you don't get through the entire lesson in the time slot, just continue where you left off in the next class.
